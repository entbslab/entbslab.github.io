...
2. 입력값
   ...
   - Repository access: **Only select repositories** → `entbslab.github.io` 선택
...
2. 입력값
   ...
   | Homepage URL | `https://entbslab.github.io/` (도메인 연결 후엔 그 주소) |
...
1. `https://entbslab.github.io/admin/` 접속
